...
/**
 * Maps of historical stock data from BolsaYMercados.
 */
public class BolsaYMercadosHistory implements Historical {
    private static final Logger log = Logger.getLogger(
            BolsaYMercadosHistory.class.getPackage().getClass().getName());
     ...
     */
    public BolsaYMercadosHistory(final int yearFrom) {
